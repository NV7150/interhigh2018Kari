...
public abstract class Ability : MonoBehaviour {
	...
	public int Strength {
		...
		protected set {
			...
			strength = (strength < 50) ? strength : 50;
			defStrParam();
		}
	}
	...
	public int Technic {
		...
		protected set {
			technic = value;
			technic = (technic >= 0) ? technic : 0;
			technic = (technic <= 50) ? technic : 50;
			defTechParam();
		}
	}
	...
	public int Toughness {
		...
		protected set {
			toughness = value;
			toughness = (toughness >= 0) ? toughness : 0;
			toughness = (toughness <= 50) ? toughness : 50;
			defToughParam();
		}
	}
	...
	/// 技巧依存の能力値を設定します
	/// </summary>
	protected virtual void defTechParam() {
	...
	/// 敏捷性依存の能力を設定します
	/// </summary>
	protected virtual void defAgiParam() {
	...
	/// 体力依存の能力を設定します
	/// </summary>
	protected virtual void defToughParam() {
